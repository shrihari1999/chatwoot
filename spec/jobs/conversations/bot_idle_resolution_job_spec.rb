...
RSpec.describe Conversations::BotIdleResolutionJob do
  ...
  # A conversation the bot currently owns: pending, with the bot as assignee.
  def bot_conversation(last_activity_at:)
    create(:conversation, account: account, inbox: inbox, status: :pending,
                          assignee_agent_bot: bot_inbox.agent_bot, last_activity_at: last_activity_at)
  end
