...
ActiveRecord::Schema[7.1].define(version: 2026_08_19_000000) do
  ...
  create_table "canned_responses", id: :serial, force: :cascade do |t|
    ...
    t.integer "content_variant_cursor", default: 0, null: false
  ...
  create_table "channel_lazada", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_id"], name: "index_channel_lazada_on_shop_id", unique: true
  end
  ...
  create_table "inboxes", id: :serial, force: :cascade do |t|
    ...
    t.jsonb "out_of_office_message_variants", default: [], null: false
    t.integer "out_of_office_variant_cursor", default: 0, null: false
