...
class AgentBuilder
  ...
  def find_or_create_user
    ...
    # custom_attributes (e.g. seatalk_profile_id) is a fork addition — preserve it.
    User.new(email: email, name: @name, password: temp_password, password_confirmation: temp_password,
             custom_attributes: custom_attributes || {}).tap do |new_user|
