...
const translationKeys = {
  ...
  'cannedresponse:create': `AUDIT_LOGS.CANNED_RESPONSE.ADD`,
  'cannedresponse:update': `AUDIT_LOGS.CANNED_RESPONSE.EDIT`,
  'cannedresponse:destroy': `AUDIT_LOGS.CANNED_RESPONSE.DELETE`,
  'cannedresponsecategory:create': `AUDIT_LOGS.CANNED_RESPONSE_CATEGORY.ADD`,
  'cannedresponsecategory:update': `AUDIT_LOGS.CANNED_RESPONSE_CATEGORY.EDIT`,
  'cannedresponsecategory:destroy': `AUDIT_LOGS.CANNED_RESPONSE_CATEGORY.DELETE`,
...
export const EVENT_TYPE_GROUPS = [
  ...
  },
  {
    ...
    types: [
      ...
      { value: 'CannedResponse', key: 'CANNED_RESPONSES' },
      { value: 'CannedResponseCategory', key: 'CANNED_RESPONSE_CATEGORIES' },
    ],
  },
  {
    key: 'CONVERSATIONS',
