...
#
# Both Messenger and Instagram accept the same shape:
#   {
...
#   }
#
# Centralising this here keeps Facebook::SendReactionService and
# Instagram::SendReactionService free of duplicated payload code.
