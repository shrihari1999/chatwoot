...
| Unsend / recall / delete a message | ◀ in | ✅ yes | recall pushes status=1 message + a system message when buyer OR seller recalls (Sec: Message recall) | ✅ yes | incoming_message_service.rb:12-15 status==1 -> Lazada::IncomingRecallService marks the incoming message deleted |
