Rails.application.routes.draw do
  ...
  if ActiveModel::Type::Boolean.new.cast(ENV.fetch('CW_API_ONLY_SERVER', false))
    ...
    get '/app/accounts/:account_id/settings/inboxes/new/tiktok_shop', to: 'dashboard#index', as: 'app_new_tiktok_shop_inbox'
    ...
    get '/app/accounts/:account_id/settings/inboxes/new/:inbox_id/agents', to: 'dashboard#index', as: 'app_tiktok_shop_inbox_agents'
    ...
    get '/app/accounts/:account_id/settings/inboxes/:inbox_id', to: 'dashboard#index', as: 'app_tiktok_shop_inbox_settings'
  ...
  post 'webhooks/lazada/:shop_id', to: 'webhooks/lazada#process_payload'
  ...
  post 'webhooks/tiktok_shop', to: 'webhooks/tiktok_shop#events'
  ...
  get 'tiktok/shop/callback', to: 'tiktok/shop/callbacks#show'
